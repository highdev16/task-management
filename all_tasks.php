...
$where = '1';
if ($search_str) {
    $where = '`task_name` like "%'. $search_str . '%" and `is_deleted` = 0';    
} else {
    $where = '`is_deleted` = 0';        
}
    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="page-action-links text-right">
                <a href="add_task.php?operation=create&back=all_tasks.php" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> Add new Task</a>
            </div>
        </div>
    </div>
    ...
    <table class="table table-striped table-bordered table-condensed" id='data_table'>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="edit_task.php?back=all_tasks.php&task_id=<?php echo $row['id']; ?>&operation=<?php echo urlencode(base64_encode('s' . rand(20000,10000000))); ?>" class="btn btn-primary"><i class="glyphicon glyphicon-edit" title='Edit Task'></i></a>
